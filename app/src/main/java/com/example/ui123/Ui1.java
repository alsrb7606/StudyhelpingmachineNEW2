...
//    private TextView medValue;
    ...
    private final short[] raw_data = {0};
    private final int raw_data_index= 0;
    private float[] output_data;
    private final int output_data_count = 0;
    private final int raw_data_sec_len = 85;

    private final int badPacketCount = 0;

    // internal variables
    private final boolean bInited = false;
    private final boolean bRunning = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //sd카드 권한 코드
        verifyStoragePermissions(Ui1.this);
...
//            }
        ...
        //버튼 연결
        Btbutton1 = findViewById(R.id.bt_button);
        next = findViewById(R.id.bt_next_button);
        headsetButton = findViewById(R.id.headset_button);
                ...
                Btbutton1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mBluetoothAdapter == null) {
                            Toast.makeText(context, "bluetoothconnect", Toast.LENGTH_SHORT);
                        } else {
                            Toast.makeText(context, "bluetoothconnect", Toast.LENGTH_LONG);
